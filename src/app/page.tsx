    ...
    <>
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="orb orb-gold w-96 h-96 -top-48 -left-48" style={{ animationDelay: '0s' }} />
          <div className="orb orb-emerald w-64 h-64 top-1/4 right-1/4" style={{ animationDelay: '2s' }} />
          <div className="orb orb-gold w-48 h-48 bottom-1/4 left-1/3" style={{ animationDelay: '4s' }} />
          <div className="orb orb-emerald w-72 h-72 -bottom-36 -right-36" style={{ animationDelay: '1s' }} />
        </div>
        ...
        <div className="container-custom relative z-10 pt-12">
          <div className="max-w-4xl mx-auto text-center">
            {/* Logo above title for strong brand presence */}
            <motion.img
              initial={{ opacity: 0, y: -10, scale: 0.9 }}
              animate={{ opacity: 1, y: 0, scale: 1 }}
              transition={{ duration: 0.8 }}
              src="/reikithreadfull.png"
              alt="ReikiThreads logo"
              className="mx-auto mb-6 h-[200px] md:h-[320px] lg:h-[420px] object-contain logo-hero"
            />
            ...
            <motion.div
              ...
              className="inline-flex items-center px-5 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-gold-300 text-sm mb-6"
            >
              <Sparkles className="w-4 h-4 mr-2" />
              Certified Reiki Master
            </motion.div>

            {/* Main title and tagline removed per request */}

            {/* Highlighted Description Card for improved readability */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.6 }}
              className="hero-card max-w-3xl mx-auto"
            >
              <p className="text-lg md:text-xl text-emerald-100/90 leading-relaxed mb-6">
                🌟 Transform your life through the gentle power of Reiki energy healing with a Certified Reiki Master.
                Experience profound relaxation, emotional balance, and energetic clarity — available both in-person and remotely from anywhere in the world.
              </p>

              <div className="flex flex-wrap items-center justify-center gap-4 mb-6">
                <div className="inline-flex items-center gap-3 bg-emerald-50/60 px-4 py-2 rounded-full shadow-sm">
                  <Sparkles className="w-5 h-5 text-gold-400" />
                  <span className="text-emerald-900 font-medium">✨ Deep Relaxation & Stress Relief</span>
                </div>
                <div className="inline-flex items-center gap-3 bg-emerald-50/60 px-4 py-2 rounded-full shadow-sm">
                  <Heart className="w-5 h-5 text-gold-400" />
                  <span className="text-emerald-900 font-medium">💚 Emotional Healing & Clarity</span>
                </div>
                <div className="inline-flex items-center gap-3 bg-emerald-50/60 px-4 py-2 rounded-full shadow-sm">
                  <Globe className="w-5 h-5 text-gold-400" />
                  <span className="text-emerald-900 font-medium">🌍 Distance & In-Person Healing</span>
                </div>
              </div>

              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link href="/book" className="btn-primary group text-lg py-4 px-10">
                  Book a Session
                  <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
                </Link>
                <Link href="/services" className="btn-white text-lg py-4 px-10">
